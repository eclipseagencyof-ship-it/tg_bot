...
async def teamwork_info(cq: types.CallbackQuery):
    ...
    await bot.send_photo(cq.from_user.id, photo=photo_url, caption=caption, reply_markup=kb_to_soft)
...
async def soft_tools(cq: types.CallbackQuery):
    ...
    await bot.send_message(cq.from_user.id, text2, reply_markup=kb_to_teamwork)
...
async def teamwork_info_final(cq: types.CallbackQuery):
    ...
    await bot.send_photo(cq.from_user.id, teamwork_image, caption=teamwork_text, reply_markup=kb_next)
