...
async def objection_rules(cq: types.CallbackQuery):
    ...
    text1 = (
        ...
        "🚫 Несовершеннолетние (даже в упоминаниях/ролеплее)\n"
        "🚫 Оружие любого типа\n"
        "🚫 Наркотики и их атрибуты\n"
        "🚫 Самоубийство, членовредительство\n"
        "🚫 Инцест, даже в ролевой форме\n"
        "🚫 Зоофилия (включая случайное попадание животных в кадр)\n"
    )
    ...
    text2 = (
        "🚫 Насилие, отсутствие согласия, гипноз, опьянение, пытки, "
        "садомазохистское насилие, экстремальный фистинг, калечащие операции\n"
        "🚫 Некрофилия\n"
        "🚫 Контент с мочой, рвотой, экскрементами\n"
        "🚫 Проституция и эскорт\n"
        "🚫 Оскорбления, дискриминация, угрозы\n"
        "🚫 Личные данные, документы, телефоны, логины и пр.\n"
        "🚫 Контент +18 в публичных местах\n"
        "🚫 Шантаж (blackmail)\n"
        "🚫 Продажа товаров, реклама без разрешения\n"
        "🚫 Копирование чужого контента\n"
        "🚫 Спам, накрутки, использование записанных видео как эфиров\n"
